<script>
  ...
  let iconos = [
    ...
    {
      id: 'dashboard',
      valor: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z',
    },
    {
      id: 'guardar',
      valor:
...
{#if enlace}
  <a
    class="flex items-center px-2 py-2 mt-9 text-gray-600 transition-colors
    duration-200 transform rounded dark:text-gray-400 hover:bg-green-600
    dark:hover:bg-green-500 dark:hover:text-gray-200 hover:text-gray-700"
    href={enlace}>
    {#if icono != ''}
...
{:else}
  <a
    class="flex items-center px-2 py-2 mt-9 text-transparent transform rounded"
    href={enlace}>
    {#if icono != ''}
      <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        <path fill="currentColor" d={valorIcono} />
